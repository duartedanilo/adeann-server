...
x_train, y_train = load_dataset(pd.read_csv('dataset/lstm/train.csv', encoding='utf-8', delimiter=';', header=None))
x_test, y_test = load_dataset(pd.read_csv('dataset/lstm/test.csv', encoding='utf-8', delimiter=';', header=None))
...
if NUMBER_OF_NINT is 1:
    regressor.add(LSTM(units=NINT1, activation=ACTIVATION_FUNCTION1, return_sequences=False,
                       input_shape=(lista_previsores.shape[1], NENT)))
